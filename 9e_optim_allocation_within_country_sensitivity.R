...
################################################################################
sens_run <- "hs_constraints_absent"

### Load outputs ###############################################################
d_out_all <- read_csv("optim_dataframes/optim_dataframe_country_fine_sensitivity.csv") %>%
...
write_csv(df1, paste0("optim_dataframes/fig_4_inputs_", sens_run, ".csv"))
